...
public class FormPegawaiAutonumber extends javax.swing.JFrame {
    ...
    private void autonumber(){
        try {
            String sql = "SELECT id_pegawai FROM pegawaii ORDER BY id_pegawai DESC LIMIT 1";
            ...
            if (res.next()) {
                String idPegawai = res.getString("id_pegawai");

                // Validasi format id_pegawai
                if (idPegawai.startsWith("PEG") && idPegawai.length() > 3) {
                    String NoId = idPegawai.substring(3);
                    int nomorBaru = Integer.parseInt(NoId) + 1;
                    String Nol = nomorBaru < 10 ? "00" : (nomorBaru < 100 ? "0" : "");
                    txtIdPegawai.setText("PEG" + Nol + nomorBaru);
                } else {
                    txtIdPegawai.setText("PEG001");
                }
            } else {
                txtIdPegawai.setText("PEG001");
            }
            ...
            JOptionPane.showMessageDialog(this, "Invalid format for id_pegawai: " + e.getMessage());
        }
    }
    ...
    private void cari_data() {
        ...
        try {
            ...
            if (kolomCari.equalsIgnoreCase("id pegawai")) {
                kolomDatabase = "id_pegawai";
            } else if (kolomCari.equalsIgnoreCase("nama pegawai")) {
                kolomDatabase = "nama_pegawai";
            } else {
                JOptionPane.showMessageDialog(this, "Pilihan pencarian tidak valid!");
                return; // Hentikan eksekusi jika pilihan tidak valid
            }
        
            String sql = "SELECT * FROM pegawaii WHERE " + kolomDatabase + " LIKE '%" + kataKunci + "%'";
    ...
    private void tampilkan_data(){
        ...
        try {
            int no = 1;
            String sql = "SELECT * FROM pegawaii";
            java.sql.Connection conn = ConfigDB.config();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
    ...
    private void initComponents() {
        ...
        cbxCari.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "id pegawai", "nama pegawai" }));
        ...
        tblPegawai.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "No.", "Id Pegawai", "Nama Pegawai", "Alamat", "No Telepon"
            }
        ));
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtNoTelp, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addComponent(txtIdPegawai, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        ...
        try {
            ...
            String sql = "INSERT INTO pegawaii (id_pegawai, nama_pegawai, alamat_pegawai, no_telepon) VALUES"
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE pegawaii SET id_pegawai = '" + id + "', nama_pegawai = '" + nama
            + "', alamat_pegawai = '" + alamat + "', no_telepon = '" + noTelp + "' WHERE id_pegawai = '" + id + "'";
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        try{
            ...
            String sql = "DELETE from pegawaii WHERE id_pegawai = '" + id + "'";
    ...
    private void tblPegawaiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPegawaiMouseClicked
        ...
        String id = tblPegawai.getValueAt(baris, 1).toString();
        txtIdPegawai.setText(id);

        String nama = tblPegawai.getValueAt(baris,2).toString();
        txtNamaPegawai.setText(nama);

        String alamat = tblPegawai.getValueAt(baris,3).toString();
        txtAlamat.setText(alamat);

        String noTelp = tblPegawai.getValueAt(baris,4).toString();
